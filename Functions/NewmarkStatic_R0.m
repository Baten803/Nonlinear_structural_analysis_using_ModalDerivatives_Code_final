function [V, RR, Rsup, NN, V_storage, R_storage] = NewmarkStatic_R0(X,T,D,G,U,R,nno,nel,nd)
...
R0 = R; % Load amplitude vector


%% Newmark method - Static

nstep = 100; %Number of iteration steps
nit = 30; %maximum number of residual updating steps
