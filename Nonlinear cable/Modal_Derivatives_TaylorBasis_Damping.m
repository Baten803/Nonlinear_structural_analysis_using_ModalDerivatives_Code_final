...
% Mode parameters
N_phi = 2; % Number of linear modes to use
...
Q0 = Q(X,T,G,nel,nno,V0); %Initial internal restoring force of the system
...
u_nonst = VsT_CDM_Full(11*3-1,:); %Physical nonlinear displacement at midpoint by taylor basis

% Taylor basis
figure()
plot(t_CDM,u_nonst,'-k')
xlabel('Time, t [s]')
ylabel('displacement, u [m]')
title('taylor basis displacement of midpoint')
legend('CDM nonlinear taylor basis, u_{nonsT}','Location','northeast')
